...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    if (mySprite.overlapsWith(otherSprite)) {
        mySprite.say("hooray", 500)
    } else {
        mySprite2.say("hooray", 500)
    }
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    if (mySprite.overlapsWith(otherSprite)) {
        if (controller.A.isPressed()) {
            ...
            info.changeLifeBy(-1)
            tiles.placeOnRandomTile(otherSprite, assets.tile`pit`)
        }
    } else {
...
tiles.createSpritesOnTiles(assets.tile`myTile6`, SpriteKind.Food)
tiles.createSpritesOnTiles(assets.tile`pit`, SpriteKind.Enemy)
